...
class InstagramBot:
    ...
    def lista(self):
        driver = self.driver
        driver.get("https://riovagas.com.br/tag/rio-de-janeiro/")
    ...
    def lista2(self):
        ...
        for vaga in vagas:
            ...
            arquivo = open("C:\Projeto\projeto.txt", "a")
            arquivo.writelines(dados)
        next_button = driver.find_element_by_xpath("//a[@class='next page-numbers']").click()    
    '''def login(self):
        driver = self.driver
